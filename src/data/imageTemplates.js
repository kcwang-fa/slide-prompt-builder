...
export const IMAGE_TEMPLATES = [
  ...
  },
  {
    ...
    "content": {
      "cn": "發揮你的創意幫我一起腦洞，假設{{character_groups}}使用{{social_media}}，包括回覆評論點贊，設計一些有趣、有反差的人物使用社交媒體互動朋友圈的場景，結合一些符合人物的大事件，有趣有梗有反差，製作一張{{social_media}}的截圖，使用中文，{{ratio}}。",
  ...
  },
  {
    ...
    "selections": {
      ...
      "subject": {
        "cn": "時尚女性角色",
        "en": "Fashionable Female Character"
      },
